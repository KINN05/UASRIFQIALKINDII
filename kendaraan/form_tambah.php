                ...
                <div class="card shadow p-3 mb-5 bg-body-tertiary rounded">
                    ...
                    <div class="card-body">
                        <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Status Stok</label>
                                <select class="form-control" name="status_stok" id="">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="tipe" id="">
                                    ...
                                    <?php 
                                        ...
                                        include_once('../koneksi.php');
                                        $qry_tipe = "SELECT * FROM tipe_kendaraan";
                                        $data_tipe = mysqli_query($koneksi,$qry_tipe);
                                        foreach($data_tipe as $item_tipe){
                                    ?>
                                    <option value="<?=$item_tipe['id_tipe']?>"><?=$item_tipe['nama_tipe']?></option>
                                    <?php
